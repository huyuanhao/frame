...
public class XDrawableTextView extends AppCompatTextView {
    ...
    public XDrawableTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        drawables[0] = array.getDrawable(R.styleable.XDrawableTextView_xleftDrawable);
        drawables[1] = array.getDrawable(R.styleable.XDrawableTextView_xtopDrawable);
        drawables[2] = array.getDrawable(R.styleable.XDrawableTextView_xrightDrawable);
        drawables[3] = array.getDrawable(R.styleable.XDrawableTextView_xbottomDrawable);

        widths[0] = array.getDimensionPixelSize(R.styleable.XDrawableTextView_xleftDrawableWidth, 0);
        widths[1] = array.getDimensionPixelSize(R.styleable.XDrawableTextView_xtopDrawableWidth, 0);
        widths[2] = array.getDimensionPixelSize(R.styleable.XDrawableTextView_xrightDrawableWidth, 0);
        widths[3] = array.getDimensionPixelSize(R.styleable.XDrawableTextView_xbottomDrawableWidth, 0);

        heights[0] = array.getDimensionPixelSize(R.styleable.XDrawableTextView_xleftDrawableHeight, 0);
        heights[1] = array.getDimensionPixelSize(R.styleable.XDrawableTextView_xtopDrawableHeight, 0);
        heights[2] = array.getDimensionPixelSize(R.styleable.XDrawableTextView_xrightDrawableHeight, 0);
        heights[3] = array.getDimensionPixelSize(R.styleable.XDrawableTextView_xbottomDrawableHeight, 0);
